...
%
% 2013-05-20 Handles single objects with additional arguments -DA
% 2013-06-01 Added eighth moment from Flusser and Suk
% Modifications by Daniel Asarnow
...
phi = compute_phi(compute_eta(compute_m(F,x,y)));
  
%-------------------------------------------------------------------%
function m = compute_m(F,x,y)
...
phi(8) = e.eta11 * ( (e.eta30 + e.eta12)^2 - (e.eta03 + e.eta21)^2 ) - ...
         (e.eta20 - e.eta02)*(e.eta30 + e.eta12)*(e.eta03 + e.eta21);